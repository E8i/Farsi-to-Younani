...
public class milao extends AppCompatActivity {

    private Button back62,home28,milao1,milao2,milao3,milao4,milao5,milao6,milao7,milao8,milao9,milao10,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_milao);

        home28=findViewById(R.id.home28);
        home28.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(milao.this,MainActivity.class);
                startActivity(in);
            }
        });
        back62=findViewById(R.id.back62);
        back62.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(milao.this,Edame2.class);
                startActivity(in);
            }
        });
