...
public class penao extends AppCompatActivity {

    private Button back19,home4,peinao1,peinao2,peinao3,peinao4,peinao5,peinao6,peinao7,peinao8,peinao9,peinao10,
            peinao11,peinao12,peinao13,peinao14,peinao15,peinao16,peinao17,peinao18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_penao);

        home4=findViewById(R.id.home4);
        home4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(penao.this,MainActivity.class);
                startActivity(in);
            }
        });
        ...
        back19.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(penao.this,Edame.class);
                startActivity(in);
            }
        });
