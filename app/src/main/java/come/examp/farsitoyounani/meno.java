...
public class meno extends AppCompatActivity {
    ...
    private Button back55,home21,meno1,meno2,meno3,meno4,meno5,meno6,meno7,meno8,meno9,meno10,meno11,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home21=findViewById(R.id.home21);
        home21.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(meno.this,MainActivity.class);
                startActivity(in);
            }
        });
        ...
        back55.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(meno.this,Edame2.class);
                startActivity(in);
            }
        });
