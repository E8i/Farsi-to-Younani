...
public class agapo extends AppCompatActivity {

    private Button back60,home26,agapo1,agapo2,agapo3,agapo4,agapo5,agapo6,agapo7,agapo8,agapo9,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agapo);


        home26=findViewById(R.id.home26);
        home26.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(agapo.this,MainActivity.class);
                startActivity(in);
            }
        });
        back60=findViewById(R.id.back60);
        back60.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(agapo.this,Edame2.class);
                startActivity(in);
            }
        });
