...
public class Katalaveno extends AppCompatActivity {

    private Button back33,home18,katalava1,katalava2,katalava3,katalava4,katalava5,katalava6,katalava7,katalava8,katalava9,
            katalava10,katalava11,katalava12,katalava13,katalava14,katalava15,katalava16,katalava17,katalava18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalaveno);

        back33=findViewById(R.id.back33);
        back33.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Katalaveno.this,Edame.class);
                startActivity(in);
            }
        });
        home18=findViewById(R.id.home18);
        home18.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Katalaveno.this,MainActivity.class);
                startActivity(in);
            }
        });
