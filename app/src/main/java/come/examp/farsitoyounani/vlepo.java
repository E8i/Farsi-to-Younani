...
public class vlepo extends AppCompatActivity {

    private Button back5,vlepo1,vlepo2,vlepo3,vlepo4,vlepo5,vlepo6,vlepo7,vlepo8,vlepo9,vlepo10,
            vlepo11,vlepo12,vlepo13,vlepo14,vlepo15,vlepo16,vlepo17,vlepo18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vlepo);

        back5=findViewById(R.id.back5);
        back5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(vlepo.this,MainActivity.class);
                startActivity(in);
            }
        });
