...
public class Agorazo extends AppCompatActivity {

    private Button back20,home5,agorazo1,agorazo2,agorazo3,agorazo4,agorazo5,agorazo6,agorazo7,agorazo8,agorazo9,
            agorazo10,agorazo11,agorazo12,agorazo13,agorazo14,agorazo15,agorazo16,agorazo17,agorazo18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_agorazo);

        back20=findViewById(R.id.back20);
        back20.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Agorazo.this,Edame.class);
                startActivity(in);
            }
        });
        ...
        home5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Agorazo.this,MainActivity.class);
                startActivity(in);
            }
        });
