...
public class Eftasa extends AppCompatActivity {

    private Button home2,back17,eftasa1,eftasa2,eftasa3,eftasa4,eftasa5,eftasa6,eftasa7,eftasa8,eftasa9,
            eftasa10,eftasa11,eftasa12,eftasa13,eftasa14,eftasa15,eftasa16,eftasa17,eftasa18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eftasa);

        back17=findViewById(R.id.back17);
        back17.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Eftasa.this,Edame.class);
                startActivity(in);
            }
        });
        ...
        home2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Eftasa.this,MainActivity.class);
                startActivity(in);
            }
        });
