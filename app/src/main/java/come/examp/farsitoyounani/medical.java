...
public class medical extends AppCompatActivity {
    ...
    private Button back15,tup1,helth1,helth2,helth3,helth4,helth5,helth6,helth7,helth8,helth9,helth10,helth11,
            ...
            helth34,helth35,helth36,helth37,helth38,helth39;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in=new Intent(medical.this,MainActivity.class);
                startActivity(in);
            }
        });

        tup1=findViewById(R.id.tup1);
        tup1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(medical.this,medical.class);
                startActivity(in);
            }
        });
