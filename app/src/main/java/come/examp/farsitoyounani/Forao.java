...
public class Forao extends AppCompatActivity {

    private Button back18,home3,forao1,forao2,forao3,forao4,forao5,forao6,forao7,forao8,forao9,
            forao10,forao11,forao12,forao13,forao14,forao15,forao16,forao17,forao18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_forao);

        home3=findViewById(R.id.home3);
        home3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Forao.this,MainActivity.class);
                startActivity(in);
            }
        });
        ...
        back18.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Forao.this,Edame.class);
                startActivity(in);
            }
        });
