...
public class Xtupao extends AppCompatActivity {

    private Button back26,home11,xtupao1,xtupao2,xtupao3,xtupao4,xtupao5,xtupao6,xtupao7,xtupao8,xtupao9,
            xtupao10,xtupao11,xtupao12,xtupao13,xtupao14,xtupao15,xtupao16,xtupao17,xtupao18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_xtupao);

        back26=findViewById(R.id.back26);
        back26.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Xtupao.this,Edame.class);
                startActivity(in);
            }
        });
        ...
        home11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Xtupao.this,MainActivity.class);
                startActivity(in);
            }
        });
