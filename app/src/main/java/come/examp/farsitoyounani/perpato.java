...
public class perpato extends AppCompatActivity {

    private Button back4,perpato1,perpato2,perpato3,perpato4,perpato5,perpato6,perpato7,perpato8,
            perpato9,perpato10,perpato11,perpato12,perpato13,perpato14,perpato15,perpato16,perpato17,perpato18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_perpato);

        back4=findViewById(R.id.back4);
        back4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(perpato.this,MainActivity.class);
                startActivity(in);
            }
        });
