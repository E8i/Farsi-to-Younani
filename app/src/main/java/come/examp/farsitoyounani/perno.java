...
public class perno extends AppCompatActivity {

    private Button back11,perno1,perno2,perno3,perno4,perno5,perno6,perno7,perno8,perno9,perno10,
            perno11,perno12,perno13,perno14,perno15,perno16,perno17,perno18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_perno);
        ...
        back11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in=new Intent(perno.this,MainActivity.class);
                startActivity(in);
            }
        });
