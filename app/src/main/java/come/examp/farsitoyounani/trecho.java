...
public class trecho extends AppCompatActivity {

    private Button back14,trexo1,trexo2,trexo3,trexo4,trexo5,trexo6,trexo7,trexo8,trexo9,trexo10,
            trexo11,trexo12,trexo13,trexo14,trexo15,trexo16,trexo17,trexo18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trecho);

        back14=findViewById(R.id.back14);
        back14.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(trecho.this,MainActivity.class);
                startActivity(in);
            }
        });
