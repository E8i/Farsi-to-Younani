...
public class ertha extends AppCompatActivity {

    private Button back12,ertha1,ertha2,ertha3,ertha4,ertha5,ertha6,ertha7,ertha8,ertha9,ertha10,
            ertha11,ertha12,ertha13,ertha14,ertha15,ertha16,ertha17,ertha18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ertha);

        ertha12=findViewById(R.id.back12);
        ertha12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(ertha.this,MainActivity.class);
                startActivity(in);
            }
        });
