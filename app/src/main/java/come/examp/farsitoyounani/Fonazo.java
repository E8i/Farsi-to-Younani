...
public class Fonazo extends AppCompatActivity {

    private Button back23,home8,fonazo1,fonazo2,fonazo3,fonazo4,fonazo5,fonazo6,fonazo7,fonazo8,fonazo9,fonazo10,fonazo11,
            fonazo12,fonazo13,fonazo14,fonazo15,fonazo16,fonazo17,fonazo18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fonazo);

        back23=findViewById(R.id.back23);
        back23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Fonazo.this,Edame.class);
                startActivity(in);
            }
        });
        ...
        home8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Fonazo.this,MainActivity.class);
                startActivity(in);
            }
        });
