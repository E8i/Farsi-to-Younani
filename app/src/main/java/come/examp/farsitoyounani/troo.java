...
public class troo extends AppCompatActivity {

    private Button back3,troo1,troo2,troo3,troo4,troo5,troo6,troo7,troo8,troo9,troo10,troo11,troo12,troo13,
            troo14,troo15,troo16,troo17,troo18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_troo);

        back3=findViewById(R.id.back3);
        back3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(troo.this,MainActivity.class);
                startActivity(in);
            }
        });
