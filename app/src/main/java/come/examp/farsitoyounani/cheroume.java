...
public class cheroume extends AppCompatActivity {

    private Button back59,home25,kherome1,kherome2,kherome3,kherome4,kherome5,kherome6,kherome7,kherome8,kherome9,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cheroume);

        home25=findViewById(R.id.home25);
        home25.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(cheroume.this,MainActivity.class);
                startActivity(in);
            }
        });
        back59=findViewById(R.id.back59);
        back59.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(cheroume.this,Edame2.class);
                startActivity(in);
            }
        });
