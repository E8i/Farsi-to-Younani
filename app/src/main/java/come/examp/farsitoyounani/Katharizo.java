...
public class Katharizo extends AppCompatActivity {

    private Button back29,home14,katharizo1,katharizo2,katharizo3,katharizo4,katharizo5,katharizo6,katharizo7,katharizo8,katharizo9,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_katharizo);

        back29=findViewById(R.id.back29);
        back29.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Katharizo.this,Edame.class);
                startActivity(in);
            }
        });
        ...
        home14.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Katharizo.this,MainActivity.class);
                startActivity(in);
            }
        });
