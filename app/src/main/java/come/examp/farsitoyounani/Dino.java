...
public class Dino extends AppCompatActivity {
    ...
    private Button back31,home16,dino1,dino2,dino3,dino4,dino5,dino6,dino7,dino8,dino9,dino10,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back31=findViewById(R.id.back31);
        back31.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Dino.this,Edame.class);
                startActivity(in);
            }
        });
        home16=findViewById(R.id.home16);
        home16.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Dino.this,MainActivity.class);
                startActivity(in);
            }
        });
