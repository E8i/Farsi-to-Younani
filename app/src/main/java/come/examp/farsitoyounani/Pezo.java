...
public class Pezo extends AppCompatActivity {

    private Button back32,home17,pezo1,pezo2,pezo3,pezo4,pezo5,pezo6,pezo7,pezo8,pezo9,
            pezo10,pezo11,pezo12,pezo13,pezo14,pezo15,pezo16,pezo17,pezo18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pezo);

        back32=findViewById(R.id.back32);
        back32.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Pezo.this,Edame.class);
                startActivity(in);
            }
        });
        home17=findViewById(R.id.home17);
        home17.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Pezo.this,MainActivity.class);
                startActivity(in);
            }
        });
