...
public class boro extends AppCompatActivity {
    ...
    private Button back61,home27,boro1,boro2,boro3,boro4,boro5,boro6,boro7,boro8,boro9,boro10,boro11,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home27=findViewById(R.id.home27);
        home27.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(boro.this,MainActivity.class);
                startActivity(in);
            }
        });
        back61=findViewById(R.id.back61);
        back61.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(boro.this,Edame2.class);
                startActivity(in);
            }
        });
