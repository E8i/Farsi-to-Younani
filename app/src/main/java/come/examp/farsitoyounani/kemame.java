...
public class kemame extends AppCompatActivity {

    private Button back8,kemame1,kemame2,kemame3,kemame4,kemame5,kemame6,kemame7,kemame8,kemame9,
            kemame10,kemame11,kemame12,kemame13,kemame14,kemame15,kemame16,kemame17,kemame18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kemame);

        back8=findViewById(R.id.back8);
        back8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(kemame.this,MainActivity.class);
                startActivity(in);
            }
        });
