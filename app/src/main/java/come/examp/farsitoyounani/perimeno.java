...
public class perimeno extends AppCompatActivity {

    private Button back58,home24,perimeno1,perimeno2,perimeno3,perimeno4,perimeno5,perimeno6,perimeno7,perimeno8,perimeno9,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perimeno);

        home24=findViewById(R.id.home24);
        home24.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(perimeno.this,MainActivity.class);
                startActivity(in);
            }
        });
        back58=findViewById(R.id.back58);
        back58.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(perimeno.this,Edame2.class);
                startActivity(in);
            }
        });
