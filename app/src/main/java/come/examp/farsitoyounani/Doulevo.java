...
public class Doulevo extends AppCompatActivity {

    private Button back21,home6,doulevo1,doulevo2,doulevo3,doulevo4,doulevo5,doulevo6,doulevo7,doulevo8,doulevo9,doulevo10,
            doulevo11,doulevo12,doulevo13,doulevo14,doulevo15,doulevo16,doulevo17,doulevo18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_doulevo);

        back21=findViewById(R.id.back21);
        back21.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Doulevo.this,Edame.class);
                startActivity(in);
            }
        });
        ...
        home6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Doulevo.this,MainActivity.class);
                startActivity(in);
            }
        });
