...
public class Leo extends AppCompatActivity {
    ...
    private Button back22,home7,leo1,leo2,leo3,leo4,leo5,leo6,leo7,leo8,leo9,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back22=findViewById(R.id.back22);
        back22.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Leo.this,Edame.class);
                startActivity(in);
            }
        });
        ...
        home7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Leo.this,MainActivity.class);
                startActivity(in);
            }
        });
