...
public class Grafo extends AppCompatActivity {
    ...
    private Button back30,home15,grafo1,grafo2,grafo3,grafo4,grafo5,grafo6,grafo7,grafo8,grafo9,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back30.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in=new Intent(Grafo.this,Edame.class);
                startActivity(in);
            }
        });
        ...
        home15.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Grafo.this,MainActivity.class);
                startActivity(in);
            }
        });
