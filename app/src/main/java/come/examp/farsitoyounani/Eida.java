...
public class Eida extends AppCompatActivity {

    private Button eida1,eida2,eida3,eida4,eida5,eida6,eida7,eida8,eida9,eida10,
            eida11,eida12,eida13,eida14,eida15,eida16,eida17,eida18,back16,home1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eida);

        home1=findViewById(R.id.home1);
        home1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Eida.this,MainActivity.class);
                startActivity(in);
            }
        });

        back16=findViewById(R.id.back16);
        back16.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Eida.this,Edame.class);
                startActivity(in);
            }
        });
