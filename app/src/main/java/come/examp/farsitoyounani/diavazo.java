...
public class diavazo extends AppCompatActivity {

    private Button home22,back56,diavazo1,diavazo2,diavazo3,diavazo4,diavazo5,diavazo6,diavazo7,diavazo8,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diavazo);


        home22=findViewById(R.id.home22);
        home22.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(diavazo.this,MainActivity.class);
                startActivity(in);
            }
        });
        back56=findViewById(R.id.back56);
        back56.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(diavazo.this,Edame2.class);
                startActivity(in);
            }
        });
