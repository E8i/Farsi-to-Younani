...
public class Poulao extends AppCompatActivity {

    private Button back27,home12,poulao1,poulao2,poulao3,poulao4,poulao5,poulao6,poulao7,poulao8,poulao9,
            poulao10,poulao11,poulao12,poulao13,poulao14,poulao15,poulao16,poulao17,poulao18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_poulao);

        back27=findViewById(R.id.back27);
        back27.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Poulao.this,Edame.class);
                startActivity(in);
            }
        });
        ...
        home12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Poulao.this,MainActivity.class);
                startActivity(in);
            }
        });
