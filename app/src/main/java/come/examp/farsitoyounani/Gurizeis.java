...
public class Gurizeis extends AppCompatActivity {

    private Button back25,home10,gerizo1,gerizo2,gerizo3,gerizo4,gerizo5,gerizo6,gerizo7,gerizo8,gerizo9,
            gerizo10,gerizo11,gerizo12,gerizo13,gerizo14,gerizo15,gerizo16,gerizo17,gerizo18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gurizeis);

        back25=findViewById(R.id.back25);
        back25.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Gurizeis.this,Edame.class);
                startActivity(in);
            }
        });
        ...
        home10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Gurizeis.this,MainActivity.class);
                startActivity(in);
            }
        });
