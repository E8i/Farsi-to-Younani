...
public class Fovame extends AppCompatActivity {

    private Button back28,home13,fovoume1,fovoume2,fovoume3,fovoume4,fovoume5,fovoume6,fovoume7,fovoume8,fovoume9,
            fovoume10,fovoume11,fovoume12,fovoume13,fovoume14,fovoume15,fovoume16,fovoume17,fovoume18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fovame);

        back28=findViewById(R.id.back28);
        back28.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Fovame.this,Edame.class);
                startActivity(in);
            }
        });
        ...
        home13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Fovame.this,MainActivity.class);
                startActivity(in);
            }
        });
