...
public class ponao extends AppCompatActivity {

    private Button home20,back54,ponao1,ponao2,ponao3,ponao4,ponao5,ponao6,ponao7,ponao8,ponao9,
            ponao10,ponao11,ponao12,ponao13,ponao14,ponao15,ponao16,ponao17,ponao18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ponao);

        home20=findViewById(R.id.home20);
        home20.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(ponao.this,MainActivity.class);
                startActivity(in);
            }
        });
        back54=findViewById(R.id.back54);
        back54.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(ponao.this,Edame2.class);
                startActivity(in);
            }
        });
