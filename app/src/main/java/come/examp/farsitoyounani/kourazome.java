...
public class kourazome extends AppCompatActivity {

    private Button back57,home23,kourazome1,kourazome2,kourazome3,kourazome4,kourazome5,kourazome6,kourazome7,kourazome8,kourazome9,kourazome10,kourazome11,kourazome12
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kourazome);

        home23=findViewById(R.id.home23);
        home23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(kourazome.this,MainActivity.class);
                startActivity(in);
            }
        });
        back57=findViewById(R.id.back57);
        back57.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(kourazome.this,Edame2.class);
                startActivity(in);
            }
        });
