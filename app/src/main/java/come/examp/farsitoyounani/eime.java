...
public class eime extends AppCompatActivity {

    private Button back10,eime1,eime2,eime3,eime4,eime5,eime6,eime7,eime8,eime9,eime10,eime11,
            eime12,eime13,eime14,eime15,eime16,eime17,eime18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eime);

        back10=findViewById(R.id.back10);
        back10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(eime.this,MainActivity.class);
                startActivity(in);
            }
        });
