...
public class Dipsao extends AppCompatActivity {

    private Button back24,home9,dipsao1,dipsao2,dipsao3,dipsao4,dipsao5,dipsao6,dipsao7,dipsao8,dipsao9,
            dipsao10,dipsao11,dipsao12,dipsao13,dipsao14,dipsao15,dipsao16,dipsao17,dipsao18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dipsao);

        back24=findViewById(R.id.back24);
        back24.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Dipsao.this,Edame.class);
                startActivity(in);
            }
        });
        ...
        home9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(Dipsao.this,MainActivity.class);
                startActivity(in);
            }
        });
