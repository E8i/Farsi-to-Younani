...
public class gelo extends AppCompatActivity {

    private Button back7,gelo1,gelo2,gelo3,gelo4,gelo5,gelo6,gelo7,gelo8,gelo9,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in=new Intent(gelo.this,MainActivity.class);
                startActivity(in);
            }
        });
