...
public class akouo extends AppCompatActivity {

    private Button back6,akou1,akou2,akou3,akou4,akou5,akou6,akou7,akou8,akou9,akou10,
            akou11,akou12,akou13,akou14,akou15,akou16,akou17,akou18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_akouo);

        back6=findViewById(R.id.back6);
        back6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(akouo.this,MainActivity.class);
                startActivity(in);
            }
        });
