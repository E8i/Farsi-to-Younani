...
public class pino extends AppCompatActivity {

    private Button back13,pino1,pino2,pino3,pino4,pino5,pino6,pino7,pino8,pino9,pino10,
            pino11,pino12,pino13,pino14,pino15,pino16,pino17,pino18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pino);

        back13=findViewById(R.id.back13);
        back13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in=new Intent(pino.this,MainActivity.class);
                startActivity(in);
            }
        });
